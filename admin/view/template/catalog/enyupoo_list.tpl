                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width:100px;" class="text-left">商品上传</td>
                                             <td class="text-center"><lable>又拍网址:</lable><input id="yupoourl" class="form-control" name="yupoourl" value="" type="text"></td>
                                       ...
                                       <?php
                                        ...
                                        <tr>
                                            ...
                                            echo $_COOKIE["category"];
                                             ...
                                             <td class="text-center"><input class="form-control" name="price1" type="text" value="<?php if(isset($_COOKIE["price"])){
                                            echo $_COOKIE["price"];
                                            } ?>"></td>
