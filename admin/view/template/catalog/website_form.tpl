    ...
    <div class="panel panel-default">
      ...
      <div class="col-sm-4">
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order"><?php echo $entry_status; ?></label>
            <div class="col-sm-10">
               <select id="input-status" class="form-control" name="status">
                       
                       <?php if($status=='0'){  
                       echo '<option value="0">禁用</option><option value="1">启用</option>';
                       }else{
                       echo '<option value="1">启用</option><option value="0">禁用</option>'; 
                       }  ?>
