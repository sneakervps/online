...
<div id="content">
            ...
            <div class="container-fluid recurring">
                                            ...
                                            <td style="width:100px;" class="text-left">鞋子尺码</td>
                                             ...
                                             <select id="selectoption_id3" name="filter_image" class="form-control">
                                                ...
                                                <option value="Select Size|||US8/UK7.5/Eur41 1/3|||US8.5/UK8/Eur42|||US9/UK8.5/Eur42 2/3|||US9.5/UK9/Eur43 1/3|||US10/UK9.5/Eur44|||US10.5/UK10/Eur44 2/3|||US11/UK10.5/Eur45 1/3|||US11.5/UK11/Eur46|||US12/UK11.5/Eur46 2/3|||US13/UK12.5/Eur48">Adidas Size</option>
                                                       <option value="Select Size|||US7/UK6.5/EUR40|||US8/UK7.5/EURO41|||US8.5/U8/EURO42|||US9.5/UK9/EURO43|||US10/UK9.5/EURO44|||US11/UK10.5/EURO45">Adidas Men Size</option>
                                                <option value="Select Size|||US5/UK3.5/EUR36|||US6/UK4.5/EUR37.3|||US6.5/UK5/EUR38|||US7.5/UK6/EUR39.3">Adidas Women Size</option>
                                            </select>
                                            </td>
                                             <td class="text-center">
                ...
                <script>  
                 ...
                 <div class="panel-body">
                       <form action="<?php echo $optionaction; ?>" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    <tbody>
                                        <tr>
                                            <td style="width:100px;" class="text-left">尺码下架</td>
                                             <td style="width:300px;" class="text-center"><lable>型号:</lable><input id="model" class="form-control" name="model" type="text" value=""></td>
                                            <td class="text-center"><lable>尺码名称:</lable><input id="option_name" class="form-control" name="option_name" type="text" value=""></td>
                                            <td class="text-center"><lable>尺码:</lable><input id="option_value" class="form-control" name="option_value" type="text" value=""></td>
                                            <td class="text-center">
                                             <select id="option_status" class="form-control" name="option_status">
                                             <option value="0">下架</option>
                                             <option value="1">上架</option>
                                             </select>
                                            </td>
                                            <td class="text-right"><button type="submit" form="form-option" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="保存"><i class="fa fa-save"></i></button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
