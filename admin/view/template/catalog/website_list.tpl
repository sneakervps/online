          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><input type="checkbox" name="selected[]" value="<?php echo$website['id']; ?>" /></td>
                  <td class="text-left"><?php echo $website['id']; ?></td>
                  <td class="text-left"><?php echo $website['url']; ?></td>
                  <td class="text-right"><?php echo $website['status']; ?></td>
                  <td class="text-right"><a href="<?php echo $website['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
